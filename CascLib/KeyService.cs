...
namespace CASCLib
{
    public class KeyService
    {
        private static Dictionary<ulong, byte[]> keys = new Dictionary<ulong, byte[]>()
        {
            ...
            //[0xB408D6CDE8E0D4C1] = "????????????????????????????????".ToByteArray(), // TactKeyId 290
            ...
            //[0xDCB5C5DC78520BD6] = "????????????????????????????????".ToByteArray(), // TactKeyId 298
            //[0x566DF4A5A9E3341F] = "????????????????????????????????".ToByteArray(), // TactKeyId 299
            //[0x9183F8AAA603704D] = "????????????????????????????????".ToByteArray(), // TactKeyId 300
            //[0x856D38B447512C51] = "????????????????????????????????".ToByteArray(), // TactKeyId 301
            [0x1D0614B43A9D6DF9] = "1847398AE16C0869C8DA6BA284BA6351".ToByteArray(), // TactKeyId 302
            //[0x19742EF8BC509417] = "????????????????????????????????".ToByteArray(), // TactKeyId 303
            //[0x0A88670B2C572700] = "????????????????????????????????".ToByteArray(), // TactKeyId 304
            //[0xDA2615B5C0237D39] = "????????????????????????????????".ToByteArray(), // TactKeyId 306
            //[0xB6FF5BC63B2F8172] = "????????????????????????????????".ToByteArray(), // TactKeyId 307
            //[0x90E01E041D38A8B0] = "????????????????????????????????".ToByteArray(), // TactKeyId 309
            //[0x8FD76F6044F9AAB1] = "????????????????????????????????".ToByteArray(), // TactKeyId 310
            //[0x40377D9CE69C6E30] = "????????????????????????????????".ToByteArray(), // TactKeyId 311
            //[0xFDEE9569100B1D53] = "????????????????????????????????".ToByteArray(), // TactKeyId 312
            //[0x4F68D9D5A1918F0D] = "????????????????????????????????".ToByteArray(), // TactKeyId 313
            //[0x99882D68AADCFA6D] = "????????????????????????????????".ToByteArray(), // TactKeyId 314
            //[0x02CC0FC116A9C190] = "????????????????????????????????".ToByteArray(), // TactKeyId 315
            //[0xBC5C79FC6E592D81] = "????????????????????????????????".ToByteArray(), // TactKeyId 316
            //[0xC737DD0E709977BD] = "????????????????????????????????".ToByteArray(), // TactKeyId 317
            //[0x33C93E43A1846B30] = "????????????????????????????????".ToByteArray(), // TactKeyId 318
            //[0x240745D093CEBD04] = "????????????????????????????????".ToByteArray(), // TactKeyId 319
            //[0x73E8CCF0812E8809] = "????????????????????????????????".ToByteArray(), // TactKeyId 320
            //[0xED4224DDF3776EB0] = "????????????????????????????????".ToByteArray(), // TactKeyId 322
            //[0x1297977C87A557D5] = "????????????????????????????????".ToByteArray(), // TactKeyId 324
            //[0x6CD8165A18D613CA] = "????????????????????????????????".ToByteArray(), // TactKeyId 325
            // BNA 1.5.0 Alpha
