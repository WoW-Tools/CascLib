...
namespace CASCLib
{
    public class KeyService
    {
        private static Dictionary<ulong, byte[]> keys = new Dictionary<ulong, byte[]>()
        {
            ...
            //[0x259EE68CD9E76DBA] = "????????????????????????????????".ToByteArray(), // TactKeyId 253
            //[0x6A026290FBDB3754] = "????????????????????????????????".ToByteArray(), // TactKeyId 255
            [0xCF72FD04608D36ED] = "0A889976D02FA8D00F7AF0017AD721F".ToByteArray(), // TactKeyId 257
            //[0x17F07C2E3A45DB3D] = "????????????????????????????????".ToByteArray(), // TactKeyId 258
            //[0xC050FA06BB0538F6] = "????????????????????????????????".ToByteArray(), // TactKeyId 260
            //[0xAB5CDD3FC321831F] = "????????????????????????????????".ToByteArray(), // TactKeyId 261
            //[0xA7B7D1F12395040E] = "????????????????????????????????".ToByteArray(), // TactKeyId 262
            // BNA 1.5.0 Alpha
