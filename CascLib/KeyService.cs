...
namespace CASCLib
{
    public class KeyService
    {
        private static Dictionary<ulong, byte[]> keys = new Dictionary<ulong, byte[]>()
        {
            ...
            //[0x943AE6AC59D361D9] = "????????????????????????????????".FromHexString(), // TactKeyId 341
            ...
            //[0x152155855D497807] = "????????????????????????????????".FromHexString(), // TactKeyId 353
            ...
            //[0x01A08F7CDA6E8F17] = "????????????????????????????????".FromHexString(), // TactKeyId 364
            //[0xB91972925E37456B] = "????????????????????????????????".FromHexString(), // TactKeyId 365
            ...
            //[0xA8BBCCA0A621E518] = "????????????????????????????????".FromHexString(), // TactKeyId 380
            //[0x7D38C6BF343CAB32] = "????????????????????????????????".FromHexString(), // TactKeyId 381
            //[0xD01FFF442611F3C0] = "????????????????????????????????".FromHexString(), // TactKeyId 382
            // BNA 1.5.0 Alpha
