...
namespace CASCLib
{
    public class KeyService
    {
        private static Dictionary<ulong, byte[]> keys = new Dictionary<ulong, byte[]>()
        {
            ...
            //[0xA2798DFCB1250E3E] = "????????????????????????????????".FromHexString(), // TactKeyId 402
            [0x27C95702825CEEA9] = "75F90192F6F560E2F58829FCBD4EC59E".FromHexString(), // TactKeyId 403
            //[0x4637768B740A71B7] = "????????????????????????????????".FromHexString(), // TactKeyId 404
            ...
            //[0x0A6701308BD0BCD6] = "????????????????????????????????".FromHexString(), // TactKeyId 415
            //[0xA4541C671097D0BD] = "????????????????????????????????".FromHexString(), // TactKeyId 416
            //[0xF294CB91E66CDBA7] = "????????????????????????????????".FromHexString(), // TactKeyId 417
            //[0x5157D7ACE0AF2642] = "????????????????????????????????".FromHexString(), // TactKeyId 418
            //[0x3ACBD2001F88F34B] = "????????????????????????????????".FromHexString(), // TactKeyId 419
            //[0xD289F4D4AF724C4D] = "????????????????????????????????".FromHexString(), // TactKeyId 420
            //[0xD4C28A92DDFB407B] = "????????????????????????????????".FromHexString(), // TactKeyId 421
            //[0x482F9F5FF11201C7] = "????????????????????????????????".FromHexString(), // TactKeyId 422
            //[0x073344682FE80C0F] = "????????????????????????????????".FromHexString(), // TactKeyId 423
            //[0x73B2859937BDE2B1] = "????????????????????????????????".FromHexString(), // TactKeyId 424
            //[0xF7E1D001DC9D1339] = "????????????????????????????????".FromHexString(), // TactKeyId 425
            //[0xAE5194D30435C4FB] = "????????????????????????????????".FromHexString(), // TactKeyId 426
            //[0xAA0C3B515E495282] = "????????????????????????????????".FromHexString(), // TactKeyId 427
            //[0x583C5B29BF208655] = "????????????????????????????????".FromHexString(), // TactKeyId 428
            //[0x71046E55CD9DA78A] = "????????????????????????????????".FromHexString(), // TactKeyId 431
            //[0xBB2E41027A527755] = "????????????????????????????????".FromHexString(), // TactKeyId 432
